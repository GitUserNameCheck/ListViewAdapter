...
public class UserListAdapter extends BaseAdapter {
    ...
    // класса: avatar, name, phoneNumber
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (u.avatar) {
            case DOG: ivUserpic.setImageResource(R.drawable.dog); break;
            case BEAR: ivUserpic.setImageResource(R.drawable.bear); break;
            case JOKER: ivUserpic.setImageResource(R.drawable.joker); break;
            case MAYA: ivUserpic.setImageResource(R.drawable.maya); break;
            case FOX: ivUserpic.setImageResource(R.drawable.fox); break;
        }
